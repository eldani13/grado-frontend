...
function Categorias() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F5F5F3] dark:bg-gradient-to-tr dark:from-gray-900 dark:via-gray-800 dark:to-black dark:text-white">
      <Nav />
        ...
        <main className="flex-1 p-8 overflow-auto ml-64">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            {filteredCategorias.map((categoria) => (
              <div
                key={categoria.id}
                className="bg-[#979797] bg-gradient-to-r dark:from-gray-800 dark:to-gray-700 rounded-lg shadow-lg p-6 flex flex-col"
              >
                <div className="mb-4">
                  <div className="flex items-center mb-3">
                    <FolderOpenIcon className="h-8 w-8 text-white dark:text-blue-400 mr-3" />
